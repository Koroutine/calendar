...
<div
  ...
  onpointerdown={{ handleEvent: () => {}, stopPropagation: true }}
  onpointerdownoutside={handlePointerDownOutside}
>
  <div class={$theme.dayHead}>
    <time
      datetime={toISOString($_popupDate, 10)}
      use:setContent={$_intlDayPopover.format($_popupDate)}
    ></time>
    ...
    <a
      ...
      onclick={{ handleEvent: close, stopPropagation: true }}
